...
namespace App\Http\Controllers\Api\V1\Adver;
...
use function App\Http\Controllers\Api\Adver\auth;
use function App\Http\Controllers\Api\Adver\public_path;
...
class SaleController extends BaseController
{
    ...
    public function index()
    {
        ...
        return new AdverCollection($sale->latest('id')->limit(5)->paginate(5));
    }
    ...
    public function rules()
    {
        ...
        $ruleSaleAdv = [
            ...
            'color' => 'required|integer', //رنگ تبلیغ
        ...
        try {
            DB::transaction(function () use ($adver, $request) {
                ...
                $adver->sale->update([
                    ...
                    'color_id' => $request->color,//رنگ تبلیغ
                    'price' => $request->price,
                    'cash' => $request->cash,
