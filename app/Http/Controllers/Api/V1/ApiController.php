...
use Facades\App\Repositories\Cache\InteriorColorRepository;
 ...
 */
    ...
    /**
     * return all Interior color from cache
     *
     * @return mixed
     */
    public function getInteriorColors()
    {
        $interiorColors  = InteriorColorRepository::all();
        return response()->json($interiorColors, 200);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function getInteriorColorById($id)
    {
        $color = InteriorColorRepository::find($id, ['title']);
        return $color->title;
    }
    ...
    /**
     * show new version for npotify in application
     *
     * @return \Illuminate\Http\Response
     */
