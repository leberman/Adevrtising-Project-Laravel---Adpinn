...
<head>
    ...
    <title>@yield('title', 'پنل مدیریت ادپین')</title>
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">سلام @if (auth()->user()->name != null) {{auth()->user()->name}} @else کاربر @endif عزیز، به پنل مدیریت ادپین خوش آمدید</h3>
                </div>
...
{{--                </div>--}}
    ...
    @if(!in_array(Route::current()->getName(),['login','register']))
        <footer class="footer"> تمام حقوق برای ادپین محفوظ می باشد. </footer>
    @endif
