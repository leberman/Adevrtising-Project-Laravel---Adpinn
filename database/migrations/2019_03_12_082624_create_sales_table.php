...
class CreateSalesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sales', function (Blueprint $table) {
            ...
            $table->integer('interiorcolor_id')->comment('رنگ داخلی کابینه تبلیغ');
            ...
            $table->boolean('in_place')->comment('نزد ادپین؟'); //true false
            ...
            $table->integer('car_status')->comment('وضعیت تبلیغ'); //کارکرده،صفر،حواله،کارتکس،پیش فروش
